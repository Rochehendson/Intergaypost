...
/decl/communication_channel/pray/do_communicate(var/mob/communicator, var/message, var/speech_method_type)
	...
	for(var/m in GLOB.player_list)
		...
		if(M.client.holder && M.client.get_preference_value(/datum/client_preference/staff/show_chat_prayers) == GLOB.PREF_SHOW)
			receive_communication(communicator, M, "\[<a href='byond://?_src_=holder;adminspawncookie=\ref[communicator]'>SC</a>\] \[<a href='byond://?_src_=holder;subtlemessage=\ref[communicator]'>SM</a>\] \[<a href='byond://?_src_=holder;adminplayeropts=\ref[src]'>PP</a>\]<span class='notice'>\icon[cross] <b><font color=purple>PRAY: </font>[key_name(communicator, 1)]: </b>[message]</span>")
