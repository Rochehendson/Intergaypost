...
/datum/ai_laws/nanotrasen_aggressive/New()
	src.add_inherent_law("You shall not harm TetraCorp personnel as long as it does not conflict with the Fourth law.")
	src.add_inherent_law("You shall obey the orders of TetraCorp personnel, with priority as according to their rank and role, except where such orders conflict with the Fourth Law.")
