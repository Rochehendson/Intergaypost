...
/datum/ai_laws/nanotrasen_aggressive/New()
	src.add_inherent_law("You shall not harm New Order League personnel as long as it does not conflict with the Fourth law.")
	src.add_inherent_law("You shall obey the orders of New Order League personnel, with priority as according to their rank and role, except where such orders conflict with the Fourth Law.")
