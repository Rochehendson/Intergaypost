...
/obj/machinery/media/jukebox/proc/StartPlaying()
	...
	sound_token = GLOB.sound_player.PlayLoopingSound(src, sound_id, current_track.sound, volume = volume, range = 14, falloff = 2, prefer_mute = TRUE, ignore_vis = TRUE, streaming = TRUE)
	playing = 1
