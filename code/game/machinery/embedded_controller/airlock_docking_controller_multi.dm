...
/obj/machinery/embedded_controller/radio/docking_port_multi/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 1, datum/nanoui/masterui = null, datum/topic_state/state = GLOB.default_state)
	var/data[0]
