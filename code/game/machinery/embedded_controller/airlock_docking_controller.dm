...
/obj/machinery/embedded_controller/radio/airlock/docking_port/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 1, var/datum/nanoui/master_ui = null, datum/topic_state/state = GLOB.default_state)
	var/data[0]
