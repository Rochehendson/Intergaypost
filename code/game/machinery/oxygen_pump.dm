#define PUMP_DEFAULT_RELEASE_PRESSURE ONE_ATMOSPHERE
...
/obj/machinery/oxygen_pump/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1)
	...
	if(tank)
		...
		data["defaultReleasePressure"] = round(PUMP_DEFAULT_RELEASE_PRESSURE)
...
/obj/machinery/oxygen_pump/Topic(href, href_list)
	...
	if (href_list["dist_p"])
		if (href_list["dist_p"] == "reset")
			tank.distribute_pressure = PUMP_DEFAULT_RELEASE_PRESSURE
