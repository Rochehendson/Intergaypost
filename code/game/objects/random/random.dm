...
/obj/random/loot/spawn_choices()
	return list(/obj/random/energy = 10,
				...
				/obj/item/weapon/surgery_tool/surgicaldrill = 7,
				/obj/item/weapon/surgery_tool/FixOVein = 7,
				/obj/item/weapon/surgery_tool/retractor = 7,
				/obj/item/weapon/surgery_tool/hemostat = 7,
				/obj/item/weapon/surgery_tool/cautery = 7,
				/obj/item/weapon/surgery_tool/bonesetter = 7,
				/obj/item/weapon/surgery_tool/bonegel = 7,
				/obj/item/weapon/surgery_tool/circular_saw = 7,
				/obj/item/weapon/surgery_tool/scalpel = 7,
