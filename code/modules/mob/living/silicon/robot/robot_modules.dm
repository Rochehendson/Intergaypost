...
/obj/item/weapon/robot_module/medical/surgeon/New()
	...
	src.modules += new /obj/item/weapon/surgery_tool/scalpel/manager(src)
	src.modules += new /obj/item/weapon/surgery_tool/hemostat(src)
	src.modules += new /obj/item/weapon/surgery_tool/retractor(src)
	src.modules += new /obj/item/weapon/surgery_tool/cautery(src)
	src.modules += new /obj/item/weapon/surgery_tool/bonegel(src)
	src.modules += new /obj/item/weapon/surgery_tool/FixOVein(src)
	src.modules += new /obj/item/weapon/surgery_tool/bonesetter(src)
	src.modules += new /obj/item/weapon/surgery_tool/circular_saw(src)
	src.modules += new /obj/item/weapon/surgery_tool/surgicaldrill(src)
...
/obj/item/weapon/robot_module/research/New()
	...
	src.modules += new /obj/item/weapon/wirecutters(src)
	src.modules += new /obj/item/weapon/crowbar(src)
	src.modules += new /obj/item/weapon/surgery_tool/scalpel/laser3(src)
	src.modules += new /obj/item/weapon/surgery_tool/circular_saw(src)
	src.modules += new /obj/item/weapon/extinguisher/mini(src)
	src.modules += new /obj/item/weapon/reagent_containers/syringe(src)
	src.modules += new /obj/item/weapon/gripper/chemistry(src)
