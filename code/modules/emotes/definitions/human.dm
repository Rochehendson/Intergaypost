...
/decl/emote/human/dance/do_emote(var/mob/living/carbon/human/user)
	...
	addtimer(CALLBACK(user, TYPE_PROC_REF(/mob/living/carbon, do_dancing_animation), 10), 20) //dance immediately, then again after 2 and 4 seconds
	addtimer(CALLBACK(user, TYPE_PROC_REF(/mob/living/carbon, do_dancing_animation), 10), 40)
