...
/obj/machinery/mineral/mint/attack_hand(user as mob)
	...
	if (chosen == "gold")
		...
		dat += text("<a href='byond://?src=\ref[src];choose=gold'>Choose</A>")
	dat += text("<br><font color='#888888'><b>Silver inserted: </b>[amt_silver]</font> ")
	if (chosen == "silver")
		dat += text("chosen")
	else
		dat += text("<a href='byond://?src=\ref[src];choose=silver'>Choose</A>")
	dat += text("<br><font color='#555555'><b>Iron inserted: </b>[amt_iron]</font> ")
	if (chosen == "iron")
		dat += text("chosen")
	else
		dat += text("<a href='byond://?src=\ref[src];choose=iron'>Choose</A>")
	dat += text("<br><font color='#8888ff'><b>Diamond inserted: </b>[amt_diamond]</font> ")
	if (chosen == "diamond")
		dat += text("chosen")
	else
		dat += text("<a href='byond://?src=\ref[src];choose=diamond'>Choose</A>")
	dat += text("<br><font color='#ff8800'><b>Phoron inserted: </b>[amt_phoron]</font> ")
	if (chosen == "phoron")
		dat += text("chosen")
	else
		dat += text("<a href='byond://?src=\ref[src];choose=phoron'>Choose</A>")
	dat += text("<br><font color='#008800'><b>Uranium inserted: </b>[amt_uranium]</font> ")
	if (chosen == "uranium")
		dat += text("chosen")
	else
		dat += text("<a href='byond://?src=\ref[src];choose=uranium'>Choose</A>")
	...
	dat += text("<a href='byond://?src=\ref[src];chooseAmt=-10'>-10</A> ")
	dat += text("<a href='byond://?src=\ref[src];chooseAmt=-5'>-5</A> ")
	dat += text("<a href='byond://?src=\ref[src];chooseAmt=-1'>-1</A> ")
	dat += text("<a href='byond://?src=\ref[src];chooseAmt=1'>+1</A> ")
	dat += text("<a href='byond://?src=\ref[src];chooseAmt=5'>+5</A> ")
	dat += text("<a href='byond://?src=\ref[src];chooseAmt=10'>+10</A> ")

	dat += text("<br><br>In total this machine produced <font color='green'><b>[newCoins]</b></font> coins.")
	dat += text("<br><a href='byond://?src=\ref[src];makeCoins=[1]'>Make coins</A>")
