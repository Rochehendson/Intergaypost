...
obj/item/weapon/paper/admin/proc/updateDisplay()
	usr << browse("<HTML><HEAD><meta charset='utf-8'><TITLE>[name]</TITLE></HEAD><BODY>[headerOn ? header : ""][info_links][stamps][footerOn ? footer : ""][interactions]</BODY></HTML>", "window=[name];can_close=0")
